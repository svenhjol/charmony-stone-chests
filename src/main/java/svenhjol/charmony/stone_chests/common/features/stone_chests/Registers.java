...
public class Registers extends Setup<StoneChests> {
    ...
    public final Map<ChestMaterial, Supplier<ChestBlock>> chestBlocks = new HashMap<>();
    public final Map<ChestMaterial, Supplier<ChestBlockItem>> chestBlockItems = new HashMap<>();
    ...
    public Registers(StoneChests feature) {
        ...
        for (var material : ChestMaterial.values()) {
